...
public class Driver {
    ...
    private static ArrayList<Dog> dogList = new ArrayList<Dog>(); // Added dog ArrayList  <-- NEW COMMENT: dog list created for testing and reservation

    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);

        initializeMonkeyList(); // Call method to initialize monkey list
        initializeDogList();    // NEW: initialize dog list for testing reserveAnimal()
    ...
    // NEW METHOD: Adds dogs to a list for testing reserveAnimal()
    public static void initializeDogList() {
        Dog dog1 = new Dog("Rex", "German Shepherd", "male", "4", "60", "01-01-2020", "United States", "in service", false, "United States");
        Dog dog2 = new Dog("Luna", "Labrador", "female", "3", "55", "02-15-2021", "Canada", "in service", false, "Canada");
    ...
    public static void reserveAnimal(Scanner scanner) {
        ...
        System.out.println("Enter animal type to reserve (dog or monkey): ");
        ...
        if (animalType.equalsIgnoreCase("dog")) {
            for (Dog dog : dogList) {
                if (dog.getTrainingStatus().equalsIgnoreCase("in service")
                    ...
                    System.out.println("Dog " + dog.getName() + " has been reserved in " + country + ".");
                    reserved = true;
                    break;
                }
            }
        ...
        // Reserve a monkey
            ...
            for (Monkey monkey : monkeyList) {
                if (monkey.getTrainingStatus().equalsIgnoreCase("in service")
                    ...
                    System.out.println("Monkey " + monkey.getName() + " has been reserved in " + country + ".");
                    reserved = true;
                    break;
                }
            }
